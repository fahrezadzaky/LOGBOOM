...
// Query data from database based on $year1 and $year2
if (isset($_GET['year1']) && isset($_GET['year2'])) {
    $year1 = $_GET['year1'];
    $year2 = $_GET['year2'];
    // Adjust your date format and range as necessary for your query
    $startDate = $year1 . '-01-01';
    $endDate = $year2 . '-12-31';

    $data = query("SELECT * FROM pelaporan WHERE tgl_kegiatan BETWEEN '$startDate' AND '$endDate'");
}
...
header('Content-Disposition: attachment;filename="report_tahunan.xlsx"');
