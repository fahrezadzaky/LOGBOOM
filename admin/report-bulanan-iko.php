...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Report Bulanan IKO</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="index.php">Report</a></li>
            <li class="breadcrumb-item active">Report Bulanan IKO</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="card">
      ...
      <div class="card-body">
        <?php if (isset($_POST['month']) && isset($_POST['year'])) : ?>
          <a href="cetakpdf-iko_bulan.php?month=<?php echo $_POST['month']; ?>&year=<?php echo $_POST['year']; ?>" class="btn btn-primary">PDF</a>
          <a href="cetakexcel-iko_bulan.php?month=<?php echo $_POST['month']; ?>&year=<?php echo $_POST['year']; ?>" class="btn btn-success">Excel</a>
        <?php endif; ?>
      </div>
      <div class="card-body">
