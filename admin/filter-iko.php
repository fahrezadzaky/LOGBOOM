    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-calendar-day mr-3"></i>Rekap Harian IKO</h3>
        ...
        <div class="card-body">
          <form action="report-harian-iko.php" method="POST">
            <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-calendar-week mr-3"></i>Rekap Bulanan IKO</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button>
        ...
        <div class="card-body">
        <form action="report-bulanan-iko.php" method="POST">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-calendar-alt mr-3"></i>Rekap Tahunan IKO</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button>
        ...
        <div class="card-body">
        <form action="report-tahunan-iko.php" method="POST">
            <div class="col-md-12">
